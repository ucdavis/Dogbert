...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <%= string.Format("<a href='{0}#{1}'>Back to Project</a>", Url.RouteUrl(new {controller="Project", action="Edit", id=Model.Project.Id}), Dogbert.Core.Resources.StaticValues.Tab_Requirements) %>
    </div>
    ...
    <% Html.RenderPartial("RequirementDetailForm"); %>
    <% } %>
</asp:Content>
